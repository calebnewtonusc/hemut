  ...
  return (
    <div className="flex-1 flex flex-col items-center justify-center gap-5 bg-[#080d1a] min-h-screen">
      ...
      <div className="text-center max-w-xs">
        ...
        <h1 className="text-white font-semibold text-xl">Fleet</h1>
        <p className="text-white/35 text-sm mt-2 leading-relaxed">Complete fleet inventory, maintenance scheduling, and vehicle performance tracking.</p>
      </div>
    </div>
  );
}
