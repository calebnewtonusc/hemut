...
export const metadata: Metadata = { title: "Live Dispatch · Hemut" };
  ...
  return (
    <div className="flex-1 flex flex-col items-center justify-center gap-5 bg-[#080d1a] min-h-screen">
      ...
      <div className="text-center max-w-xs">
        ...
        <h1 className="text-white font-semibold text-xl">Live Dispatch</h1>
        <p className="text-white/35 text-sm mt-2 leading-relaxed">Real-time load dispatching with AI-optimized driver matching and route planning.</p>
      </div>
    </div>
  );
}
