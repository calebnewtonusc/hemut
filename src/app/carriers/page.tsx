...
export const metadata: Metadata = { title: "Carriers · Hemut" };
  ...
  return (
    <div className="flex-1 flex flex-col items-center justify-center gap-5 bg-[#080d1a] min-h-screen">
      ...
      <div className="text-center max-w-xs">
        ...
        <h1 className="text-white font-semibold text-xl">Carriers</h1>
        <p className="text-white/35 text-sm mt-2 leading-relaxed">Carrier network management, rate negotiations, and performance scorecards.</p>
      </div>
    </div>
  );
}
