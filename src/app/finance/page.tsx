...
export const metadata: Metadata = { title: "Finance · Hemut" };
  ...
  return (
    <div className="flex-1 flex flex-col items-center justify-center gap-5 bg-[#080d1a] min-h-screen">
      ...
      <div className="text-center max-w-xs">
        ...
        <p className="text-white/35 text-sm mt-2 leading-relaxed">Revenue tracking, invoice management, factoring integration, and IFTA reporting.</p>
      </div>
    </div>
  );
}
